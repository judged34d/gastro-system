...
sudo cp "$DIR/gastro-telegram-bot.service" /etc/systemd/system/
...
sudo systemctl enable gastro-backend.service gastro-frontend.service gastro-cloudflared.service gastro-telegram-bot.service
sudo systemctl enable gastro-wifi-autoswitch.timer
sudo systemctl enable gastro-setup.service
sudo systemctl restart gastro-backend.service gastro-frontend.service gastro-cloudflared.service gastro-telegram-bot.service
